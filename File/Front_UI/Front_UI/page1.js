...
$(document).ready(function()
{
   ...
   var current_customerOpts =
   {
      ...
      direction: '',
      pagination: true,
      pagination_img_default: 'images/current_customer-default.png',
      pagination_img_active: 'images/current_customer-active.png',
      pause: null,
      start: 0
   };
   ...
   var Carousel3Opts =
   {
      ...
      direction: 'left',
      pagination: true,
      pagination_img_default: 'images/Carousel3-default.png',
      pagination_img_active: 'images/Carousel3-active.png',
      pause: null,
      start: 0
   };
   ...
   var Carousel4Opts =
   {
      ...
      direction: 'left',
      pagination: true,
      pagination_img_default: 'images/Carousel4-default.png',
      pagination_img_active: 'images/Carousel4-active.png',
      pause: null,
      start: 0
   };
   ...
   var Carousel5Opts =
   {
      ...
      direction: 'left',
      pagination: true,
      pagination_img_default: 'images/Carousel5-default.png',
      pagination_img_active: 'images/Carousel5-active.png',
      pause: null,
      start: 0
   };
